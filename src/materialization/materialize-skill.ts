...
import { resolveCanonicalSkillPathResult, validateCanonicalNameResult } from "../shared/canonical-name.js";
import {
  errSkm,
  fromSkmPromise,
  okSkm,
...
import type { MaterializationStrategy } from "../manifest/types.js";
